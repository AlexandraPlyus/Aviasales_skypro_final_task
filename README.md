...
Запустив тесты необходимо дождаться окончания тестирования, не предпринимая каких-либо действий, иначе могут возникать ошибки.  
  
Для формирования отчёта allure нужно последовательно отправить команды:  
